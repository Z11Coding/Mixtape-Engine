...
@:keep @:file("C:/Work/HaxeUI/backends/haxeui-openfl/./assets/styles/default/main.css") @:noCompletion #if display private #end class __ASSET__styles_default_main_css extends haxe.io.Bytes {}
@:keep @:file("C:/Work/HaxeUI/backends/haxeui-openfl/./assets/styles/main.css") @:noCompletion #if display private #end class __ASSET__styles_main_css extends haxe.io.Bytes {}
@:keep @:font("build/openfl/html5/obj/webfont/Roboto-Medium.ttf") @:noCompletion #if display private #end class __ASSET__fonts_roboto_medium_ttf extends lime.text.Font {}
@:keep @:file("C:/Work/HaxeUI/backends/haxeui-openfl/./assets/fonts/Roboto-Regular.eot") @:noCompletion #if display private #end class __ASSET__fonts_roboto_regular_eot extends haxe.io.Bytes {}
@:keep @:file("C:/Work/HaxeUI/backends/haxeui-openfl/./assets/fonts/Roboto-Regular.svg") @:noCompletion #if display private #end class __ASSET__fonts_roboto_regular_svg extends haxe.io.Bytes {}
@:keep @:font("build/openfl/html5/obj/webfont/Roboto-Regular.ttf") @:noCompletion #if display private #end class __ASSET__fonts_roboto_regular_ttf extends lime.text.Font {}
@:keep @:file("C:/Work/HaxeUI/backends/haxeui-openfl/./assets/fonts/Roboto-Regular.woff") @:noCompletion #if display private #end class __ASSET__fonts_roboto_regular_woff extends haxe.io.Bytes {}
@:keep @:file("C:/Work/HaxeUI/backends/haxeui-openfl/./assets/fonts/Roboto-Regular.woff2") @:noCompletion #if display private #end class __ASSET__fonts_roboto_regular_woff2 extends haxe.io.Bytes {}
