...
class HXCPP_CLASS_ATTRIBUTES Main_obj : public ::hx::Object
{
	...
	public:
		...
		static ::Dynamic mainTest_dyn();

		static void mainBytes();
		static ::Dynamic mainBytes_dyn();

		static void testIndenticalNames();
		static ::Dynamic testIndenticalNames_dyn();

		static void fullTestParseEntireSourceCode();
		static ::Dynamic fullTestParseEntireSourceCode_dyn();
