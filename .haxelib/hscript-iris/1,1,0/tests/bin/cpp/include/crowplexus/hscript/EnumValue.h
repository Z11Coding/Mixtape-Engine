...
HX_DECLARE_STACK_FRAME(_hx_pos_9caaa3cdca7dc0aa_177_new)
...
class HXCPP_CLASS_ATTRIBUTES EnumValue_obj : public ::hx::Object
{
	...
	public:
		...
		void __construct(::String enumName,::String name,::cpp::VirtualArray args);
		...
		inline static ::hx::ObjectPtr< EnumValue_obj > __new(::String enumName,::String name,::cpp::VirtualArray args) {
			::hx::ObjectPtr< EnumValue_obj > __this = new EnumValue_obj();
			__this->__construct(enumName,name,args);
			return __this;
		}

		inline static ::hx::ObjectPtr< EnumValue_obj > __alloc(::hx::Ctx *_hx_ctx,::String enumName,::String name,::cpp::VirtualArray args) {
...
HXLINE( 178)		( ( ::crowplexus::hscript::EnumValue)(__this) )->enumName = enumName;
HXLINE( 179)		( ( ::crowplexus::hscript::EnumValue)(__this) )->name = name;
HXLINE( 180)		( ( ::crowplexus::hscript::EnumValue)(__this) )->args = args;
            	}
