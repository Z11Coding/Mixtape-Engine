...
HX_DEFINE_STACK_FRAME(_hx_pos_eaf56286afd1764c_31_new,"haxe.iterators.StringKeyValueIterator","new",0x47385434,"haxe.iterators.StringKeyValueIterator.new","/usr/share/haxe/std/haxe/iterators/StringKeyValueIterator.hx",31,0xb1d37ef5)
HX_LOCAL_STACK_FRAME(_hx_pos_eaf56286afd1764c_46_hasNext,"haxe.iterators.StringKeyValueIterator","hasNext",0x301ba341,"haxe.iterators.StringKeyValueIterator.hasNext","/usr/share/haxe/std/haxe/iterators/StringKeyValueIterator.hx",46,0xb1d37ef5)
HX_LOCAL_STACK_FRAME(_hx_pos_eaf56286afd1764c_53_next,"haxe.iterators.StringKeyValueIterator","next",0x0a115a9f,"haxe.iterators.StringKeyValueIterator.next","/usr/share/haxe/std/haxe/iterators/StringKeyValueIterator.hx",53,0xb1d37ef5)
namespace haxe{
namespace iterators{

void StringKeyValueIterator_obj::__construct(::String s){
            	HX_STACKFRAME(&_hx_pos_eaf56286afd1764c_31_new)
...
bool StringKeyValueIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_eaf56286afd1764c_46_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(StringKeyValueIterator_obj,hasNext,return )
 ...
 ::Dynamic StringKeyValueIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_eaf56286afd1764c_53_next)
