...
HX_DEFINE_STACK_FRAME(_hx_pos_16f15bc870b8d2a7_299_new,"haxe.ds._List.ListKeyValueIterator","new",0x709bf3d8,"haxe.ds._List.ListKeyValueIterator.new","/usr/share/haxe/std/haxe/ds/List.hx",299,0xd0d1e26e)
HX_LOCAL_STACK_FRAME(_hx_pos_16f15bc870b8d2a7_305_hasNext,"haxe.ds._List.ListKeyValueIterator","hasNext",0x6af1e4e5,"haxe.ds._List.ListKeyValueIterator.hasNext","/usr/share/haxe/std/haxe/ds/List.hx",305,0xd0d1e26e)
HX_LOCAL_STACK_FRAME(_hx_pos_16f15bc870b8d2a7_308_next,"haxe.ds._List.ListKeyValueIterator","next",0x17d96a7b,"haxe.ds._List.ListKeyValueIterator.next","/usr/share/haxe/std/haxe/ds/List.hx",308,0xd0d1e26e)
namespace haxe{
namespace ds{
namespace _List{

void ListKeyValueIterator_obj::__construct( ::haxe::ds::_List::ListNode head){
            	HX_STACKFRAME(&_hx_pos_16f15bc870b8d2a7_299_new)
...
bool ListKeyValueIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_16f15bc870b8d2a7_305_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(ListKeyValueIterator_obj,hasNext,return )
 ...
 ::Dynamic ListKeyValueIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_16f15bc870b8d2a7_308_next)
