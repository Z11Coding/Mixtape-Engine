...
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_57_list,"Lambda","list",0x9f7ad705,"Lambda.list","/usr/share/haxe/std/Lambda.hx",57,0x92dd64dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_70_map,"Lambda","map",0x3d8fa1d5,"Lambda.map","/usr/share/haxe/std/Lambda.hx",70,0x92dd64dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_78_mapi,"Lambda","mapi",0xa01df8f4,"Lambda.mapi","/usr/share/haxe/std/Lambda.hx",78,0x92dd64dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_88_flatten,"Lambda","flatten",0xc5a6d37d,"Lambda.flatten","/usr/share/haxe/std/Lambda.hx",88,0x92dd64dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_97_flatMap,"Lambda","flatMap",0xc589381c,"Lambda.flatMap","/usr/share/haxe/std/Lambda.hx",97,0x92dd64dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_108_has,"Lambda","has",0x3d8bd693,"Lambda.has","/usr/share/haxe/std/Lambda.hx",108,0x92dd64dc)
...
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_144_foreach,"Lambda","foreach",0xb8902543,"Lambda.foreach","/usr/share/haxe/std/Lambda.hx",144,0x92dd64dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_157_iter,"Lambda","iter",0x9d877fbf,"Lambda.iter","/usr/share/haxe/std/Lambda.hx",157,0x92dd64dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_168_filter,"Lambda","filter",0x2a5e121f,"Lambda.filter","/usr/share/haxe/std/Lambda.hx",168,0x92dd64dc)
...
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_225_empty,"Lambda","empty",0xe6d5d206,"Lambda.empty","/usr/share/haxe/std/Lambda.hx",225,0x92dd64dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_235_indexOf,"Lambda","indexOf",0xbf6a7082,"Lambda.indexOf","/usr/share/haxe/std/Lambda.hx",235,0x92dd64dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_255_find,"Lambda","find",0x9b838ae0,"Lambda.find","/usr/share/haxe/std/Lambda.hx",255,0x92dd64dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_273_findIndex,"Lambda","findIndex",0xea9b1412,"Lambda.findIndex","/usr/share/haxe/std/Lambda.hx",273,0x92dd64dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_289_concat,"Lambda","concat",0x6cf8fb7b,"Lambda.concat","/usr/share/haxe/std/Lambda.hx",289,0x92dd64dc)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Lambda_obj,array,return )
 ...
 ::haxe::ds::List Lambda_obj::list( ::Dynamic it){
            	HX_GC_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_57_list)
...
::cpp::VirtualArray Lambda_obj::map( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_70_map)
...
::cpp::VirtualArray Lambda_obj::mapi( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_78_mapi)
HXLINE(  79)		int i = 0;
...
::cpp::VirtualArray Lambda_obj::flatten( ::Dynamic it){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_88_flatten)
...
::cpp::VirtualArray Lambda_obj::flatMap( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_97_flatMap)
...
bool Lambda_obj::has( ::Dynamic it, ::Dynamic elt){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_108_has)
HXLINE( 109)		{
...
bool Lambda_obj::foreach( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_144_foreach)
HXLINE( 145)		{
...
void Lambda_obj::iter( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_157_iter)
...
::cpp::VirtualArray Lambda_obj::filter( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_168_filter)
...
bool Lambda_obj::empty( ::Dynamic it){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_225_empty)
...
int Lambda_obj::indexOf( ::Dynamic it, ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_235_indexOf)
HXLINE( 236)		int i = 0;
HXLINE( 237)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Lambda_obj,indexOf,return )
 ...
 ::Dynamic Lambda_obj::find( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_255_find)
HXLINE( 256)		{
...
int Lambda_obj::findIndex( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_273_findIndex)
HXLINE( 274)		int i = 0;
HXLINE( 275)		{
...
::cpp::VirtualArray Lambda_obj::concat( ::Dynamic a, ::Dynamic b){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_289_concat)
