...
void Error_obj::__construct( ::crowplexus::hscript::ErrorDef e,int pmin,int pmax,::String origin,int line){
            	HX_STACKFRAME(&_hx_pos_c2c9be46dde141ff_144_new)
HXLINE( 145)		this->e = e;
HXLINE( 146)		this->pmin = pmin;
HXLINE( 147)		this->pmax = pmax;
HXLINE( 148)		this->origin = origin;
...
HXDLIN( 153)		return ::crowplexus::hscript::Printer_obj::errorToString(::hx::ObjectPtr<OBJ_>(this));
            	}
