...
HX_DEFINE_STACK_FRAME(_hx_pos_31fff5ab54a2c1a2_37_new,"crowplexus.hscript.LocalVar","new",0xf5ffcc73,"crowplexus.hscript.LocalVar.new","crowplexus/hscript/Interp.hx",37,0x864063c3)
namespace crowplexus{
namespace hscript{

void LocalVar_obj::__construct( ::Dynamic r,bool _hx_const){
            	HX_STACKFRAME(&_hx_pos_31fff5ab54a2c1a2_37_new)
HXDLIN(  37)		this->r = r;
HXDLIN(  37)		this->_hx_const = _hx_const;
            	}
