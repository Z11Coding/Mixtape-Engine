...
HX_DEFINE_STACK_FRAME(_hx_pos_693684c71293979c_43_new,"crowplexus.hscript.DeclaredVar","new",0x8a1c3f5a,"crowplexus.hscript.DeclaredVar.new","crowplexus/hscript/Interp.hx",43,0x864063c3)
namespace crowplexus{
namespace hscript{

void DeclaredVar_obj::__construct(::String n, ::crowplexus::hscript::LocalVar old){
            	HX_STACKFRAME(&_hx_pos_693684c71293979c_43_new)
HXDLIN(  43)		this->n = n;
HXDLIN(  43)		this->old = old;
            	}
