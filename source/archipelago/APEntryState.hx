...
class APEntryState extends FlxState
{
	...
	override function create()
	{
		...
		var yamlGen = new PsychUIButton(0, 0, "Generate YAML", onGenYaml);
	...
	function onGenYaml()
	{
		...
		gameSettings.songList = globalSongList;
	...
	override function update(elapsed:Float)
	{
		...
		// I'll make a physical button later
		if (FlxG.keys.justPressed.Q) openSubState(new archipelago.APSettingsSubState());
